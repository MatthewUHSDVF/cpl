holly.utils = {
    ...
    showError: function (msg, objectId) {
        ...
        var msgHtml = "<div style='height:34px;overflow:hidden;text-align:center;'><div style='overflow:hidden;padding-top:4px'>" +
            ...
            "<button class='btn btn-sm btn-danger' type='button' style='float:left;margin-left:5px;' onclick=\"javascript:holly.phone.phone_closeDiv();\">关 闭</button></div>";
        $('#' + objectId).empty();
